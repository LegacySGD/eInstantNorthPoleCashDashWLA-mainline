...
public class NorthPoleCashDashWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(NorthPoleCashDashWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/NorthPoleCashDashWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/NorthPoleCashDashWLAIW/InitOutcome.xml").getDocumentElement();
